...
String facefile = "F:/opencv/InputImg/people/cascade.xml";
String eyefile = "F:/opencv/opencv/sources/data/haarcascades/haarcascade_eye.xml";
...
int main(int argc, char** argv) {
	...
	while (capture.read(frame)) {
		...
		face_cascader.detectMultiScale(gray, faces, 1.2, 6, 0, Size(50, 50));
